...
cards:
  ...
  # ── RUBBLE (generated by base raids, not purchasable) ────────────────────
  ...
  - id: rubble
    ...
    passive_vp: -1
    unplayable: true
    effect: "Curse: Dead weight from a base raid. Reduces your VP by 1. Cannot be played — takes up a card slot in your deck. Can be trashed by trash effects."
